...
#define SAT_DISCOVERY_FRAME_HEADER_SIZE       (sizeof (uint8_t) + SAT_UUID_BINARY_SIZE + sizeof (uint8_t))
#define SAT_DISCOVERY_FRAME_ANNOUNCE_SIZE     (SAT_DISCOVERY_FRAME_SERVICE_NAME_SIZE + SAT_DISCOVERY_FRAME_PORT + SAT_DISCOVERY_FRAME_ADDRESS)
#define SAT_DISCOVERY_FRAME_PAYLOAD_SIZE      SAT_DISCOVERY_FRAME_ANNOUNCE_SIZE
#define SAT_DISCOVERY_FRAME_SIZE              (SAT_DISCOVERY_FRAME_HEADER_SIZE + SAT_DISCOVERY_FRAME_PAYLOAD_SIZE)
