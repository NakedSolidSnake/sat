...
void test_static_array_capacity_limit() {
    ...
    static_test_item_t items[] = {
        ...
        {2, "Second item"},
        {3, "Third item"},
        {4, "Fourth item - should fail"}  // This should fail
    };
...
void test_static_array_operations() {
    sat_array_t *array = NULL;
    sat_array_args_t args = {
        .size = 5,
        .object_size = sizeof(static_test_item_t),
...
void test_static_array_boundary_conditions() {
    sat_array_t *array = NULL;
    sat_array_args_t args = {
        .size = 2,
