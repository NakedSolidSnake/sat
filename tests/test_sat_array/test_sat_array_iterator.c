...
void test_array_iterator_basic (void)
{
...
void test_array_iterator_empty_array (void)
{
    sat_array_t *array = NULL;
    sat_array_args_t args =
    {
...
void test_array_iterator_single_element (void)
{
    sat_array_t *array = NULL;
    sat_array_args_t args =
    {
...
void test_array_iterator_modification_during_iteration (void)
{
    sat_array_t *array = NULL;
    sat_array_args_t args =
    {
...
void test_array_iterator_multiple_iterators (void)
{
    sat_array_t *array = NULL;
    sat_array_args_t args =
    {
...
void test_array_iterator_dynamic_array (void)
{
    sat_array_t *array = NULL;
    sat_array_args_t args =
    {
